    ...
    <body>
        ...
        <form method="post">
            ...
            <table border="1" align="center">
                ...
                <%
                    int i = 1;
                    String sel24 = "select clg.colg_id, cou.course_id, clg.colg_name, cou.course_name, cc.colgcourse_id, clg.colg_adrs from tbl_colg clg inner join tbl_course cou inner join tbl_colgcourse cc where clg.colg_id=cc.college_id and cou.course_id=cc.course_id ";
                    ResultSet rs24 = c.selectCommand(sel24);
                    while (rs24.next()) {
                %>
                <tr>                   <td><%=i%></td>

                    <td><%=rs24.getString("colg_name")%>,<%=rs24.getString("colg_adrs") %></td>
                    <td><%=rs24.getString("course_name")%></td>
                   
                    <td><a href="Colgcourse.jsp?eid=<%=rs24.getString("colgcourse_id")%>">EDIT</a></td><br>

                <td><a href="Colgcourse.jsp?did=<%=rs24.getString("colgcourse_id")%>">Delete</a></td>
