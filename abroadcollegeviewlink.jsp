...
String str="select * from tbl_colg c,tbl_university u,tbl_country co where u.university_id=c.university_id and c.country_id=co.country_id and c.colg_id="+id ;
...
<html>
    ...
    <body>
       ...
       <tr><td >University:</td><td><%=rs.getString("university_name")%></td></tr>
         ...
         <tr><td >Country:</td><td><%=rs.getString("country_name")%></td></tr>
